...
void SetupProspectStyle(){
  std::cout << std::endl << "PROSPECT Experiment plot defaults." << std::endl;
...
// Palette used from here: http://ultrahigh.org/2007/08/making-pretty-root-color-palettes/
void SetSmoothPalette() {
  const Int_t NRGBs = 5;
